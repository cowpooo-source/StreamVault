        ...
        {authUser && (
          <div style={{ display: "flex", gap: ".5rem", marginBottom: "1.2rem" }}>
            ...
            <button type="button" onClick={() => window.location.href = `${API}/api/auth/facebook`}
              ...
              onMouseEnter={e => {e.currentTarget.style.background = "rgba(255,255,255,0.05)"; e.currentTarget.style.color="var(--t1)"}}
              onMouseLeave={e => {e.currentTarget.style.background = "transparent"; e.currentTarget.style.color="var(--t2)"}}>
              <svg viewBox="0 0 24 24" width="14" height="14" xmlns="http://www.w3.org/2000/svg" fill="#1877F2"><path d="M24 12.07C24 5.41 18.63 0 12 0S0 5.4 0 12.07C0 18.1 4.39 23.12 10.13 24v-8.44H7.08v-3.49h3.04V9.41c0-3.02 1.8-4.7 4.4-4.7 1.31 0 2.68.24 2.68.24v2.97h-1.5c-1.5 0-1.96.93-1.96 1.89v2.26h3.32l-.53 3.5h-2.8V24C19.62 23.12 24 18.1 24 12.07z"/></svg>
              Link Facebook
            </button>
          </div>
        )}
