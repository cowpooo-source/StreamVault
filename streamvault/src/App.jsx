        ...
        {authUser && (
          <div style={{ display: "flex", gap: ".5rem", marginBottom: "1.2rem" }}>
            ...
            <button type="button" onClick={() => window.location.href = `${API}/api/auth/github`}
              ...
              onMouseEnter={e => {e.currentTarget.style.background = "rgba(255,255,255,0.05)"; e.currentTarget.style.color="var(--t1)"}}
              onMouseLeave={e => {e.currentTarget.style.background = "transparent"; e.currentTarget.style.color="var(--t2)"}}>
              <svg viewBox="0 0 24 24" width="14" height="14" xmlns="http://www.w3.org/2000/svg"><path d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.44 9.83 8.21 11.44.6.11.82-.26.82-.58 0-.28-.01-1.04-.015-2.04-3.34-.46-3.98-1.84-3.98-1.84-.85-2.19-.66-2.19-.66-1.7.12-1.05 1.3-1.05 1.3-.87 2.37.62 3.7.62 3.7 2.43 4.11 3.62 3.13 3.62 3.13 .7 1.24 2.64 1.56 2.64 1.56 1.98.22 3.45-.54 3.45-.54 1.33-1.3 2.08-1.09 2.08-1.09 1.14.32 2.35-.08 2.35-.08 1.33-.74 2.08-1.09 2.08-1.09 1.14.32 2.35-.08 2.35-.08 1.62-.58 2.64-2.23 2.64-2.23v-6.58C20.56 5.91 16.14 2.42 12 2.42z" fill="#fff"/><path d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.44 9.83 8.21 11.44.6.11.82-.26.82-.58 0-.28-.01-1.04-.015-2.04-3.34-.46-3.98-1.84-3.98-1.84-.85-2.19-.66-2.19-.66-1.7.12-1.05 1.3-1.05 1.3-.87 2.37.62 3.7.62 3.7 2.43 4.11 3.62 3.13 3.62 3.13 .7 1.24 2.64 1.56 2.64 1.56 1.98.22 3.45-.54 3.45-.54 1.33-1.3 2.08-1.09 2.08-1.09 1.14.32 2.35-.08 2.35-.08 1.33-.74 2.08-1.09 2.08-1.09 1.14.32 2.35-.08 2.35-.08 1.62-.58 2.64-2.23 2.64-2.23V5.91C20.56 5.91 16.14 2.42 12 2.42z" fill="#161B22"/></svg>
              Link GitHub
            </button>
          </div>
        )}
