...
> **For agentic workers:** REQUIRED SUB-SKILL: Use `superpowers:subagent-driven-development` or `superpowers:executing-plans` to implement this plan task-by-task. Track progress with checkbox (`- [x]`) steps.
...
- [x] **Step 1: Update the state reset rules**
...
- [x] **Step 2: Update manual connection switching**
...
- [x] **Step 3: Keep invalidation behavior on reconnect**
...
- [x] **Step 4: Validate session persistence**
...
- [x] **Step 1: Define a stable source shape**
...
- [x] **Step 2: Replace first-source-wins merging**
...
- [x] **Step 3: Keep non-overlapping channels fast**
...
- [x] **Step 4: Validate guide rendering**
...
- [x] **Step 1: Use deferred search text**
...
- [x] **Step 1: Add the calculation in the player overlay**
...
- [x] **Step 2: Surface the same data in the guide where space exists**
...
- [x] **Step 3: Verify catch-up behavior is unchanged**
